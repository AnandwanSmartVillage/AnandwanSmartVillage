...
public class ActivityArticles extends  AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    //Toolbar
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView aoa = (TextView) findViewById(R.id.AOA);
        TextView aba = (TextView) findViewById(R.id.ABA);



        aoa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), articlesOnAnandwan.class));
            }
        });
        ...
        aba.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), articlesByAnandwan.class));
            }
        });
