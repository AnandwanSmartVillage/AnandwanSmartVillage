...
public class ActivityProducts extends  AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewFlipper = findViewById(R.id.vf2);
        button = (Button) findViewById(R.id.fip);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(ActivityProducts.this, ActivityDonate.class);
