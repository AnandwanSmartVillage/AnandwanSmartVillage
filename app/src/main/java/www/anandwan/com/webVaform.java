...
public class webVaform extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    //Toolbar
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLocale();
        setContentView(R.layout.activity_web_vaform);
        //toolbar
        ...
        view.loadUrl("https://anandwan.in/volunteer-application.php");
