...
public class ActivityVolunteer extends  AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    //Toolbar
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.vol);
        String text = getResources().getString(R.string.people);
        SpannableString ss= new SpannableString(text);

        StyleSpan bold = new StyleSpan(Typeface.BOLD);

        ss.setSpan(bold,151 , 175, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.visitus:
                        startActivity(new Intent(String.valueOf(getApplicationContext()),Uri.parse("https://anandwan.in/")));
    ...
    public void browser (View view){
        Intent browserIntent= new Intent(Intent.ACTION_VIEW, Uri.parse("http://anandwan.in/volunteer-application.php"));
