...
public class ViewpagerAdapterM extends PagerAdapter{
    ...
    private int[] mImageIds = new int[] {
            R.drawable.mulgavan1, R.drawable.mulgavan2, R.drawable.mulgavan3, R.drawable.mulgavan4, R.drawable.mulgavan5, R.drawable.mulgavan6
    };


    ViewpagerAdapterM(Context context){
        mContext = context;
    }
