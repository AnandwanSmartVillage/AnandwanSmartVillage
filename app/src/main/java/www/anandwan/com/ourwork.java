...
public class ourwork <adapter> extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Healthcare.class);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Education.class);
                startActivity(intent);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Livelihood.class);
                startActivity(intent);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Agriculture.class);
                startActivity(intent);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Rehabilitation.class);
                startActivity(intent);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new  Intent(ourwork.this,Environment.class);
                startActivity(intent);
            }
        });
    ...
    public class MyTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            ourwork.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
