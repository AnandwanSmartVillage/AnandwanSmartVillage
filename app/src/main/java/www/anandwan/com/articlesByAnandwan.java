...
public class articlesByAnandwan extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    //Toolbar
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_articles_by_anandwan);
        ...
        view.loadUrl("https://anandwan.in/articlesByAnandwan.php");
