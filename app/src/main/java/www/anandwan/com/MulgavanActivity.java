...
public class MulgavanActivity  extends  AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLocale();
        setContentView(R.layout.activity_mulgavan);
        ...
        leftNavM = (ImageView) findViewById(R.id.left_navM);
        rightNavM = (ImageView) findViewById(R.id.right_navM);

        final ViewpagerAdapterM viewpagerAdapterM = new ViewpagerAdapterM(this);
        viewPagerM.setAdapter(viewpagerAdapterM);

        Mpos = viewPagerM.getCurrentItem();

        leftNavM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (Mpos == 0){
                    viewPagerM.setCurrentItem(6);
                }else if (Mpos == 1){
                    viewPagerM.setCurrentItem(0);
                }else if (Mpos == 2){
                    viewPagerM.setCurrentItem(1);
                }else if (Mpos == 3){
                    viewPagerM.setCurrentItem(2);
                }else if (Mpos == 4){
                    viewPagerM.setCurrentItem(3);
                }else if (Mpos == 5){
                    viewPagerM.setCurrentItem(4);
                }
        ...
        rightNavM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        viewPagerM.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
    ...
    public void Backbtn(View view) {
        Intent intent = new Intent(MulgavanActivity.this,MainActivity.class);
